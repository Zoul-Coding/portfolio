    ...
    return (
        <CardSpotlight className="h-[100vh]">
            <div className="max-w-screen-lg mx-auto">
                <div className="flex md:justify-start justify-center h-screen items-center">
                    <div className="z-40">
                        <div className="flex md:justify-start justify-center">
                            <img src={Profile} className='w-20 h-20 rounded-full' alt="Profile Zoulkifirou SABI ADAM" />
                        </div>
                        <h1 className="md:text-5xl text-3xl md:text-start text-center font-bold relative z-0 pt-10 text-white">
                            Zoulkifirou SABI ADAM, <span className="text-yellow-200">Front end web developer 🚀</span>
                        </h1>
                        <p className="text-muted-foreground max-w-screen-md font-normal md:text-2xl text-1xl md:text-start text-center leading-[28px] pt-6">
